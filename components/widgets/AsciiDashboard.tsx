...
export const AsciiDashboard: React.FC = () => {
  return (
    <pre className="font-mono text-xs sm:text-sm text-[#9EABA2] bg-[#0B0F19] p-6 rounded-lg border border-[#EECC8C]/30 shadow-2xl overflow-x-auto whitespace-pre leading-tight max-h-[85vh] max-w-[95vw]">
      {`
╔══════════════════════════════════════════════════════════════════════════════════════════════════════════════════╗
